...
class _DistanceFilterSheetState extends State<DistanceFilterSheet> {
  ...
  void initState() {
    ...
    _distanceScrollController = FixedExtentScrollController(initialItem: _currentDistanceIndex);
                    ...
                    child: ListWheelScrollView.useDelegate(
                      ...
                      onSelectedItemChanged: (index) {
                        ...
                        if (newUnit != _tempSelectedUnit) {
                          ...
                          newController = FixedExtentScrollController(initialItem: defaultIndex);
                ...
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () {
                        ...
                        FixedExtentScrollController newController = FixedExtentScrollController(
