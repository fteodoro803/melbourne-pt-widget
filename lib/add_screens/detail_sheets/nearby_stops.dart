  ...
  Widget build(BuildContext context) {
    ...
    nearbyController.itemPositionsListener.itemPositions.addListener(() {
      final firstVisibleItem =
          nearbyController.itemPositionsListener.itemPositions.value.isNotEmpty
                ...
                child: Padding(
                  ...
                  child: ScrollablePositionedList.builder(
                    ...
                    itemPositionsListener:
                        nearbyController.itemPositionsListener,
                    shrinkWrap: true,
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Obx(() {
                        final isExpanded = nearbyController
                                .stopExpansionState[stop.id]?.value ??
                            false;
